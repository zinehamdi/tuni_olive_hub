        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
            <div class="text-center mb-6">
                <div class="flex justify-center mb-4">
                    <div class="w-20 h-20 rounded-full bg-gradient-to-br from-[#8B4513] to-[#6B3410] flex items-center justify-center shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                    </div>
                </div>
                <h2 class="text-2xl font-bold text-gray-900 mb-2">{{ __('Register as Mill') }}</h2>
                <p class="text-gray-600">{{ __('Complete the details to join as a mill on the platform') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <input type="hidden" name="role" value="mill">
                
                <!-- Personal Information Section -->
                <div class="border-b pb-6">
                    <h3 class="text-lg font-bold text-[#8B4513] mb-4 flex items-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-col sm:flex-row items-start gap-4">
                                <div class="flex-shrink-0">
                                    <template x-if="profilePreview">
                                        <img :src="profilePreview" class="w-32 h-32 rounded-full object-cover border-4 border-[#8B4513]/20 shadow-lg">
                                    </template>
                                    <template x-if="!profilePreview">
                                ...
                                <div class="flex-1">
                                    ...
                                    <label for="profile_picture" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-[#8B4513] text-[#8B4513] rounded-xl cursor-pointer hover:bg-[#8B4513] hover:text-white transition-all shadow-md hover:shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="cover_photos" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#8B4513] to-[#6B3410] text-white rounded-xl cursor-pointer hover:shadow-lg transition-all shadow-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Submit Button -->
                <div class="pt-6">
                    <button type="submit" class="w-full py-4 px-6 bg-gradient-to-r from-[#8B4513] to-[#6B3410] text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center mt-6">
                        ...
                        <a href="{{ route('login') }}" class="text-[#8B4513] hover:text-[#6B3410] font-bold transition">
                            {{ __('Log in') }}
                        </a>
                    </div>
                </div>
