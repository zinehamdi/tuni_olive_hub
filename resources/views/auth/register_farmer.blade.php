        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="border-b pb-6">
                    <h3 class="text-lg font-bold text-[#6A8F3B] mb-4 flex items-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-col sm:flex-row items-start gap-4">
                                <div class="flex-shrink-0">
                                    <template x-if="profilePreview">
                                        <img :src="profilePreview" class="w-32 h-32 rounded-full object-cover border-4 border-[#6A8F3B]/20 shadow-lg">
                                    </template>
                                    <template x-if="!profilePreview">
                                ...
                                <div class="flex-1">
                                    ...
                                    <label for="profile_picture" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-[#6A8F3B] text-[#6A8F3B] rounded-xl cursor-pointer hover:bg-[#6A8F3B] hover:text-white transition-all shadow-md hover:shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="cover_photos" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#6A8F3B] to-[#5a7a2f] text-white rounded-xl cursor-pointer hover:shadow-lg transition-all shadow-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
