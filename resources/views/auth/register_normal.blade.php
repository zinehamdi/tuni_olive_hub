        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
            <div class="text-center mb-6">
                <div class="flex justify-center mb-4">
                    <div class="w-20 h-20 rounded-full bg-gradient-to-br from-[#3B82F6] to-[#2563EB] flex items-center justify-center shadow-lg">
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <h3 class="text-lg font-bold text-[#3B82F6] mb-4 flex items-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                        المعلومات الشخصية
                            ...
                            <div class="flex flex-col sm:flex-row items-start gap-4">
                                <div class="flex-shrink-0">
                                    <template x-if="profilePreview">
                                        <img :src="profilePreview" class="w-32 h-32 rounded-full object-cover border-4 border-[#3B82F6]/20 shadow-lg">
                                    </template>
                                    <template x-if="!profilePreview">
                                ...
                                <div class="flex-1">
                                    ...
                                    <label for="profile_picture" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-[#3B82F6] text-[#3B82F6] rounded-xl cursor-pointer hover:bg-[#3B82F6] hover:text-white transition-all shadow-md hover:shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="cover_photos" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white rounded-xl cursor-pointer hover:shadow-lg transition-all shadow-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Submit Button -->
                <div class="pt-6">
                    <button type="submit" class="w-full py-4 px-6 bg-gradient-to-r from-[#3B82F6] to-[#2563EB] text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center mt-6">
                        ...
                        <a href="{{ route('login') }}" class="text-[#3B82F6] hover:text-[#2563EB] font-bold transition">
                            سجل دخولك
                        </a>
                    </div>
                </div>
