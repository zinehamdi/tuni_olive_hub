        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
            <div class="text-center mb-6">
                <div class="flex justify-center mb-4">
                    <div class="w-20 h-20 rounded-full bg-gradient-to-br from-[#9333EA] to-[#7E22CE] flex items-center justify-center shadow-lg">
                        <svg class="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                        </svg>
                    </div>
                </div>
                <h2 class="text-2xl font-bold text-gray-900 mb-2">{{ __('Register as Packer') }}</h2>
                <p class="text-gray-600">{{ __('Complete the details to join as a packer on the platform') }}</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <input type="hidden" name="role" value="packer">
                
                <!-- Personal Information Section -->
                <div>
                    <h3 class="text-lg font-bold text-[#9333EA] mb-4 flex items-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-col sm:flex-row items-start gap-4">
                                <div class="flex-shrink-0">
                                    <template x-if="profilePreview">
                                        <img :src="profilePreview" class="w-32 h-32 rounded-full object-cover border-4 border-[#9333EA]/20 shadow-lg">
                                    </template>
                                    <template x-if="!profilePreview">
                                ...
                                <div class="flex-1">
                                    ...
                                    <label for="profile_picture" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-white border-2 border-[#9333EA] text-[#9333EA] rounded-xl cursor-pointer hover:bg-[#9333EA] hover:text-white transition-all shadow-md hover:shadow-lg">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <label for="cover_photos" 
                                        class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#9333EA] to-[#7E22CE] text-white rounded-xl cursor-pointer hover:shadow-lg transition-all shadow-md">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Submit Button -->
                <div class="pt-6">
                    <button type="submit" class="w-full py-4 px-6 bg-gradient-to-r from-[#9333EA] to-[#7E22CE] text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-200 flex items-center justify-center gap-2">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="text-center mt-6">
                        ...
                        <a href="{{ route('login') }}" class="text-[#9333EA] hover:text-[#7E22CE] font-bold transition">
                            {{ __('Log in') }}
                        </a>
                    </div>
                </div>
