    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg">
                <div class="p-8">
                    <form action="{{ route('admin.prices.world.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="country" id="country" required
                                    ...
                                    <option value="{{ $countryKey }}" {{ old('country') === $countryKey ? 'selected' : '' }}>
                                        {{ $countryName }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="quality" id="quality" required
                                    ...
                                    <option value="lampante" {{ old('quality') === 'lampante' ? 'selected' : '' }}>Lampante</option>
                                </select>
                                @error('quality')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="unit" id="unit" required
                                    class="w-full border-gray-300 rounded-lg shadow-sm focus:border-olive focus:ring-olive">
                                    <option value="L" {{ old('unit', 'L') === 'L' ? 'selected' : '' }}>L (لتر)</option>
