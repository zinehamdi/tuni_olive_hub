                ...
                <div x-data="{ tab: '{{ app()->getLocale() }}' }" class="mb-8">
                    ...
                    <div x-show="tab === 'fr'">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title[fr]" value="{{ $deal->title['fr'] ?? '' }}" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-bold text-gray-700 mb-2">Description (Français)</label>
                            <textarea name="description[fr]" rows="4" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">{{ $deal->description['fr'] ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div x-show="tab === 'en'">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title[en]" value="{{ $deal->title['en'] ?? '' }}" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-bold text-gray-700 mb-2">Description (English)</label>
                            <textarea name="description[en]" rows="4" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">{{ $deal->description['en'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
