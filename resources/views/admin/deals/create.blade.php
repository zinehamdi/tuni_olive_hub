...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 py-8">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-4xl font-bold text-gray-900 mb-2">{{ __('New Deal') }}</h1>
                <p class="text-gray-600">{{ __('Create a new request or service offer') }}</p>
            </div>
            ...
            <form action="{{ route('admin.deals.store') }}" method="POST">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                            <option value="demand">{{ __('Demand (Searching)') }}</option>
                            <option value="service">{{ __('Service (Providing)') }}</option>
                            <option value="supply">{{ __('Supply (Supplier)') }}</option>
                        </select>
                    </div>
                ...
                <div x-data="{ tab: 'ar' }" class="mb-8">
                    ...
                    <div x-show="tab === 'ar'" dir="rtl">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title[ar]" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition" required>
                        </div>
                        <div class="mb-4">
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="price_range" placeholder="e.g. 100 - 200 TND" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                    </div>

                    <!-- Location -->
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">{{ __('Location') }}</label>
                        <input type="text" name="location" placeholder="e.g. Kairouan, Tunisia" class="w-full px-4 py-3 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                    </div>
                </div>
                ...
                <div class="flex items-center gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="date" name="expires_at" class="px-4 py-2 rounded-xl border-2 border-gray-100 focus:border-amber-500 focus:outline-none transition">
                    </div>
                </div>
