                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex gap-3">
                            @php
                                ...
                                $fbUrl = "https://www.facebook.com/sharer/sharer.php?u=" . urlencode(route('listings.show', $listing));
                            @endphp
                            <!-- WhatsApp Share -->
