                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex gap-3">
                            @php
                                ...
                                $fbUrl = "https://www.facebook.com/sharer/sharer.php?u=" . urlencode(route('listings.show', $listing->id));
                            @endphp
                            <!-- WhatsApp Share -->
                            ...
                            <!-- Facebook Share -->
                            <a href="{{ $fbUrl }}" onclick="if (navigator.share) { event.preventDefault(); navigator.share({ title: 'منصة الزين - ZinToop', text: 'عرضي لزيت الزيتون متوفر الآن على منصة الزين! 🫒 شوف السعر والتفاصيل من هنا:', url: '{{ route('listings.show', $listing->id) }}' }).catch(err => { window.open(this.href, '_blank'); }); }" target="_blank" rel="noopener noreferrer" class="flex-1 px-4 py-3 bg-[#1877F2] text-white rounded-xl hover:bg-[#166fe5] transition font-bold text-sm shadow-sm flex items-center justify-center gap-2">
