        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 px-4">
            ...
            <div class="mb-8">
                <a href="/" class="flex flex-col items-center gap-3">
                    <img src="{{ asset('images/zintooplogo3d.jpg') }}" alt="{{ __(app()->getLocale() === 'ar' ? 'brand.name_ar' : 'brand.name_latin') }}" class="h-16 w-16 sm:h-20 sm:w-20 rounded-full object-cover shadow-lg hover:scale-105 transition">
