                        ...
                        <div x-show="showShareModal" class="inline-block align-bottom bg-white rounded-2xl text-right overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 text-center">
                                ...
                                <div class="mt-6 flex flex-col gap-3">
                                    ...
                                    <a href="{{ $fbUrl }}" target="_blank" class="w-full inline-flex justify-center items-center gap-2 rounded-xl border border-transparent shadow-sm px-4 py-3 bg-[#1877F2] text-base font-bold text-white hover:bg-[#166fe5] sm:text-lg transition">
