...
{
    use HasFactory;
    protected $fillable = ['thread_id','sender_id','body','attachments','is_flagged','is_deleted','is_hidden','read_at'];
    protected $casts = [ 'attachments' => 'array', 'is_flagged'=>'boolean','is_deleted'=>'boolean','is_hidden'=>'boolean','read_at'=>'datetime' ];
