...
6. طبيعة تحديث الأسعار: يتم تحيين أسعار أسواق الزيتون دورياً وبشكل أسبوعي (وليس لحظياً كل ثانية). عند الإجابة عن الأسعار قل دائماً: «حسب آخر تحيين متوفر في المنصة» ووجهه لرابط جدول الأسعار: https://zintoop.com/ar/prices.'
        ...
        $systemInstruction = $systemPrompt . "\n\n" . $liveContext . "\n\n"
            ...
            . "3. أسلوب الشرح: اشرح للعميل بوضوح ولباقة بالدارجة التونسية حسب موضوعه، دون إطالة مفرطة ودون قطع غير طبيعي.\n"
            ...
            . "5. رابط واحد محدد وكامل: عند الحاجة لتوجيه العميل، ضع رابطاً واحداً فقط يخدم طلبه، واكتب الرابط كاملاً في سطر مستقل:\n"
            ...
            . "6. في صفقات الجملة والحاويات الكبرى: اطلب رقم الواتساب واختم بـ [ESCALATE_ADMIN].";
