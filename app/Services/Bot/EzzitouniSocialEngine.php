...
6. طبيعة تحديث الأسعار: يتم تحيين أسعار أسواق الزيتون دورياً وبشكل أسبوعي (وليس لحظياً كل ثانية). عند الإجابة عن الأسعار قل دائماً: «حسب آخر تحيين متوفر في المنصة» ووجهه لرابط جدول الأسعار: https://zintoop.com/ar/prices.'
        ...
        $systemInstruction = $systemPrompt . "\n\n" . $liveContext . "\n\n"
            ...
            . "4. ممنوع وضع أكثر من رابط واحد فقط في الرسالة.\n"
            . "5. عدم ذكر أرقام أسعار دقيقة كأرقام مطلقة في التعليقات العامة، بل وجهه دائماً لرابط الأسعار https://zintoop.com/ar/prices أو اطلب منه مراسلتك على الخاص لتشخيص صفقته بدقة.\n"
            . "6. [ملاحظة هامة جداً]: إذا كان العميل يطلب صفقة شراء/بيع ضخمة (أطنان أو حاويات تصدير) أو مفاوضات أسعار رسمية أو يطلب التحدث مع الإدارة، اختم ردك بلباقة بعبارة تشير لتحويله للإدارة، واكتب في نهاية النص كود: [ESCALATE_ADMIN].";
