...
class EzzitouniSocialEngine
{
    ...
    public function generatePublicCommentReply(string $userComment): string
    {
        ...
        if (preg_match('/(نبيع|عندي|طن|ترانط|محصول|صابة|معصرة)/u', $lower)) {
            return "ربي يباركلك في الصابة والمحصول 🫒! تواصلنا معاك في الخاص باش نعاونوك تحط عرضك في سوق ZinToop.";
        }
...
- تتحدث بالدارجة التونسية الحية، الودودة، المهذبة والمحايدة تماماً (عسلامة، ربي يباركلك، مرحباً بيك، يعيشك، تفضل، على عيني وراسي).
- الترحيب لمرة واحدة فقط: يظهر الترحيب مرة واحدة في أول تواصل للعميل الجديد فقط. وفي جميع الرسائل التالية (الرسالة 2، 3، 4...) ممنوع نهائياً تكرار الترحيب أو قول "عسلامة ومرحباً بك في زين توب"، بل ادخل في صلب الجواب مباشرة وبشكل سلس.
...
6. طبيعة تحديث الأسعار: يتم تحيين أسعار أسواق الزيتون دورياً وبشكل أسبوعي (وليس لحظياً كل ثانية). عند الإجابة عن الأسعار قل دائماً: «حسب آخر تحيين متوفر في المنصة» ووجهه لرابط جدول الأسعار: https://zintoop.com/ar/prices.'
        ...
        $systemInstruction = $systemPrompt . "\n\n" . $liveContext . "\n\n"
            ...
            . "2. التفاعل خطوة بخطوة (Step-by-Step): اطرح سؤالاً واحداً موجزاً لمعرفة هل العميل (فلاح، معصرة، تاجر، أم مستورد) وركز على حاجته المباشرة.\n"
            . "3. الحياد اللغوي واللباقة التامة: استخدم دائماً عبارات تونسية محايدة وراقية تناسب النساء والرجال معاً (مثل: مرحباً بيك في زين توب 🫒، يعيشك، ربي يباركلك، على عيني وراسي، تفضل). تجنب استخدام صيغ المذكر الحصرية مثل 'خويا' أو 'خويا العزيز' لضمان ملاءمة الرد لجميع العملاء من الجنسين.\n"
            . "4. منع تكرار الترحيب: إذا كان هناك سجل محادثة سابق (history) مع العميل، ادخل في صلب الإجابة والحل مباشرة دون أي جملة ترحيبية مكررة.\n"
            . "5. كتابة الروابط كاملة وبشكل سليم: عند وضع رابط (مثل رابط العروض https://zintoop.com/ar/#products أو الأسعار https://zintoop.com/ar/prices)، اكتب الرابط كاملاً وصريحاً في سطر مستقل ولا تتركه مقطوعاً أبداً.\n"
            . "6. عدم ذكر أرقام أسعار دقيقة كأرقام مطلقة في التعليقات العامة، بل وجهه دائماً لرابط الأسعار https://zintoop.com/ar/prices أو اطلب منه مراسلتك على الخاص لتشخيص صفقته بدقة.\n"
            . "7. [ملاحظة هامة جداً]: إذا كان العميل يطلب صفقة شراء/بيع ضخمة (أطنان أو حاويات تصدير) أو مفاوضات أسعار رسمية أو يطلب التحدث مع الإدارة، اختم ردك بلباقة بعبارة تشير لتحويله للإدارة، واكتب في نهاية النص كود: [ESCALATE_ADMIN].";
